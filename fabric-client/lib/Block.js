...
var Block = class {
	 ...
	 * @see /protos/common/common.proto
	 */
	static decodeTransaction(proto_processed_transaction) {
...
function decodeChaincodeActionPayload(payload_bytes) {
	...
	payload.chaincode_proposal_payload = decodeChaincodeProposalPayload(proto_chaincode_action_payload.getChaincodeProposalPayload());//TODO more decode needed
	payload.action = decodeChaincodeEndorsedAction(proto_chaincode_action_payload.getAction());

	return payload;
};

//decodeChaincodeProposalPayload
function decodeChaincodeProposalPayload(chaincode_proposal_payload_bytes) {
    ...
    // console.info(Object.keys(proto_chaincode_proposal_payload))
...
function decodeChaincodeAction(action_bytes) {
	...
	chaincode_action.events = decodeChaincodeEvents(proto_chaincode_action.getEvents()); //TODO should we decode these
	chaincode_action.response = decodeResponse(proto_chaincode_action.getResponse());

	return chaincode_action;
};

//decodeChaincodeEvents
